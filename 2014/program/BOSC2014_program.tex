...
be presented at the conference.  Some, but not all, of the talks will also
be presented as posters. There are also a few spaces available for last-minute
posters. If you would like to present one, please email your abstract (which
must meet the BOSC criteria of freely available source and recognized open
source license) to bosc@open-bio.org.
