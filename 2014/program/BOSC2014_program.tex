...
(O$|$B$|$F, \href{http://www.open-bio.org}{www.open-bio.org}),
a non-profit group that promotes the practice and
...
\session{Organizers}{\textit{\& ISCB Communities of Special Interest (COSIs)}}{}
\section*{BOSC Organizers}
...
chairs, and the ISCB Conference Director, Steven Leard. If you are interested
...
%\session{ISCB Communities of Special Interest (COSIs)}{Being launched at ISMB 2014}{}
\section*{ISCB Communities of Special Interest (COSIs)}

Both the Open Bioinformatics Foundation (OBF, \url{http://www.open-bio.org})
and its annual Bioinformatics Open Source Conference (BOSC) were started in
2000. Since then BOSC has been held each year as one of the Special Interest
Group (SIG) satellite meetings of the larger Intelligent Systems for Molecular
Biology (ISMB) conference run by the International Society for Computational
Biology (ISCB, \url{http://www.iscb.org}).

This year the ISCB is expanding the SIG scheme to recognise groups active
all year round, rather than just at annual meetings in conjunction with
the ISMB conference. The existing SIGs were invited to become
\href{http://www.iscb.org/iscb-affiliates-cosis}{ISCB
Communities of Special Interest (COSIs)}.

The new COSI scheme is being formally launched at ISMB 2014, the day after
BOSC, in a morning special session (SS02, Sunday, 13 July 2014, 10:30--13:25).
The OBF (including BOSC) is one of the initial twelve COSIs, and OBF
President (and BOSC committee member) Hilmar Lapp will give a brief
introduction during the COSI special session.
...
dinner the first evening of BOSC (Friday, 11 July, at 7pm) at The Asgard
...
\emph{only those who RSVP will be admitted}.
...
\session{Keynote Speakers}{Days One \& Two, 11 \& 12 July 2014}{}
...
\session{Main Talks, Lightning Talks, Posters and BOFs}{Days One \& Two, 11 \& 12 July 2014}{}
...
\session{Schedule}{Day One, 11 July 2014}{}
\section*{BOSC Schedule - Day One - Friday, 11 July 2014}
...
\session{Schedule}{Day Two, 12 July 2014}{}
\section*{BOSC Schedule - Day Two - Saturday, 12 July 2014}
...
\session{Talk and Poster Abstracts}{Days One \& Two, 11 \& 12 July 2014}{}
%\section*{Talk and Poster Abstracts}
\noindent
The abstracts are included in the order the talks will be given,
followed by the poster-only abstracts.

\section*{List of Posters}
...
%Submission 28
%17 & Firehose in The Cancer Genome Atlas: Rigorous Open Science, At Scale & Michael S. Noble &  \\
17 & \textit{Withdrawn} & \textit{Withdrawn} & \\
%Submission 30
...
%Submission 45
22 & Bio2RDF mobile: an app for biological semantic web databases & Maxime D{\'e}raspe &  \\
% Submission 46
...
% Submission 48
25 & GigaGalaxy: A GigaSolution for reproducible and sustainable genomic data publication and analysis & Scott Edmunds \\\hline
\end{tabular}
\end{center}
...
\talkposter{8}
%This info was missing from next PDF abstract...
\centerline{Author: Michael Markie (F1000 Research)}
\embed{2.5cm}{4.5cm}{0cm}{2.5cm}{Lightning-42-F1000.pdf}
...
\session{Poster-only Abstracts}{Days One \& Two, 11 \& 12 July 2014, 13:00 -- 14:00}{}
...
\onlyposter{13}
%This info was missing from next PDF abstract...
\noindent Author: Laurent Gautier\\
Software Licence: 3-clause BSD \\
Project URL: To be released by BOSC \\
\embed{3cm}{15cm}{3cm}{4cm}{PosterOnly-06-ConnectingNGS.pdf}

\onlyposter{14}
\embed{3cm}{13cm}{3cm}{3.5cm}{PosterOnly-08-MISO.pdf}
\onlyposter{15}
\embed{2.5cm}{2cm}{0.5cm}{2.5cm}{PosterOnly-12-Taverna-IPython}
\onlyposter{16}
\embed{2.5cm}{2.5cm}{0.5cm}{2.5cm}{PosterOnly-24-ancestral-reconstruction.pdf}
%Withdrawn...
%\onlyposter{17}
%\embed{2.5cm}{5.2cm}{2.5cm}{2.5cm}{PosterOnly-28-Firehose.pdf}
\onlyposter{18}
\embed{2.5cm}{5cm}{0cm}{1.1cm}{PosterOnly-30-Gepetto.pdf}
\onlyposter{19}
\embed{2.5cm}{15cm}{2.5cm}{1.7cm}{PosterOnly-33-NeoPipe.pdf}
\onlyposter{20}
\embed{2.5cm}{1.5cm}{0cm}{2.5cm}{PosterOnly-36-MyGeneInfo.pdf}
\onlyposter{21}
\embed{2.5cm}{5.5cm}{1cm}{2.5cm}{PosterOnly-37-Journey.pdf}
\onlyposter{22}
\embed{2.5cm}{2.5cm}{0.5cm}{2.5cm}{PosterOnly-45-Bio2RDF.pdf}
\onlyposter{23}
\embed{2.5cm}{3.5cm}{1cm}{2.5cm}{PosterOnly-46-Tripal.pdf}
\onlyposter{24}
%This info was missing from next PDF abstract...
\noindent Software Licence: Miscellaneous OSS licences (packaging project) \\
\noindent Project URL: \url{http://www.lab7.io/test/solutions/biobuilds/}
\embed{0.5cm}{1.5cm}{0cm}{1.2cm}{PosterOnly-47-BioBuilds.pdf}
\onlyposter{25}
\embed{2.5cm}{4.4cm}{0cm}{2.5cm}{PosterOnly-48-GigaGalaxy.pdf}

% trim = left, bottom, right, top


%\session{Open Bioinformatics Foundation Membership}{How to join the OBF officially.}{}
%\embed{1.25cm}{1.5cm}{1.25cm}{2cm}{../../OBF_membership_form.pdf}
\clearpage
\pagestyle{empty}
\embed{1cm}{3.5cm}{1cm}{2cm}{../../OBF_membership_form.pdf}
